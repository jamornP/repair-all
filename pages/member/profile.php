                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="profile_settings">
                                        <form class="form-horizontal" action="profile.php" method="POST">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="NameSurname" name="name_TH" placeholder="ชื่อ - นามสกุล" value="<?php echo $_SESSION['name_TH'];?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="NameSurname2" name="name_EN" placeholder="ชื่อ - นามสกุล" value="<?php echo $_SESSION['name_EN'];?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
